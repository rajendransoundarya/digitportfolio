    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="<div class="cc-profile-image"><a href=><img src="C:\Users\Admin26\Downloads\WhatsApp Image 2023-10-26 at 2.37.37 PM.jpeg" alt="Image"/></a></div>"><img src="" alt="Image"/></a></div>
          <div class="h2 title">soundarya
</div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>I am soundarya studying 3rd-cs in rabiammal ahamed maideen college for women</p>
           </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">
                rajsrimathi2017@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">6379627226</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">189,nadar street,thiruvarur</div>
            </div>
            <div class="row mt-3">
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p>hi i m soundarya college student i m studing 3rd year.</p>
          </div>
        </div>
      </div>
    </div>  
...
<div class="section">
  <div class="container cc-education">
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p> I know HTML  and i m a salesforce developer and i joined college in 2021.</p>
          </div>
        </div>
      </div>
    </div> 
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Soundarya</div>
